...
const InvitedCard = () => {
  ...
  //Fetch data from backend server and get normal data by filtering state.
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setShift(normalShift[0]);
      setShift1(normalShift[1]);
      setShift2(normalShift[2]);
      setShift3(normalShift[3]);
    }
    fetchData();
  }, []);

  //make the first page of normal card
  return (
    <Fragment>
